...
export default function HeaderSimple() {
  ...
  return (
    <header className={`relative min-h-screen flex items-center justify-center overflow-hidden transition-colors duration-500 ${theme === "dark" ? "bg-black" : "bg-white"}`}>
      {/* Hero Content */}
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-20 pb-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className={`mb-6 opacity-0 animate-[fadeIn_0.8s_ease-out_0.2s_forwards] ${
            ...
            <span className={`block text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight ${
          ...
          {/* Subtitle */}
          <p className={`text-xl sm:text-2xl md:text-3xl mb-8 opacity-0 animate-[fadeIn_0.8s_ease-out_0.4s_forwards] ${
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 opacity-0 animate-[fadeIn_0.8s_ease-out_0.6s_forwards]">
            ...
            <a
              href="#features"
              className={`px-8 py-4 rounded-full font-medium text-lg transition-all duration-200 hover:scale-105 ${
                theme === "dark"
          ...
          <div className="mb-16 opacity-0 animate-[fadeIn_1s_ease-out_0.8s_forwards]">
            <div className="relative mx-auto" style={{ maxWidth: "800px" }}>
              <Image
                src={theme === "dark" ? "/box_1_black.jpg" : "/box_1_white.jpg"}
                alt="Linux Box"
                width={800}
                height={600}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto opacity-0 animate-[fadeIn_0.8s_ease-out_1s_forwards]">
            {[
              ...
              <div key={index} className="text-center">
                <div className={`text-3xl sm:text-4xl font-semibold mb-1 ${
                  theme === "dark" ? "text-white" : "text-black"
                }`}>
