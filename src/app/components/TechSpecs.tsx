        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          ...
          >
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-3xl sm:text-4xl font-extrabold text-[#1d1d1f] mb-3 tracking-tight">
                Amlogic S922X-H
              </p>
              <p className="text-base sm:text-lg font-medium text-slate-700 leading-relaxed max-w-xl mx-auto">
                Potężny 6-rdzeniowy procesor (4x ARM Cortex-A73 @ 1,8 GHz i 2x
                ARM Cortex-A53 @ 2,21 GHz).
              </p>
            </div>
            <p className="text-xs sm:text-sm text-[#86868b] font-medium text-center mt-6">
              Zapewnia płynną pracę Home Assistant i aplikacji w kontenerach
              Docker.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-[#86868b] font-medium">
              64 GB eMMC 5.1 + 4 GB RAM LPDDR4
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-[#86868b] font-medium">
              Szybki transfer danych i obsługa urządzeń peryferyjnych.
            </p>
          </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-3xl font-extrabold text-[#1d1d1f] mb-2 tracking-tight">
                Wbudowane Audio Digital Stereo
              </p>
            </div>
            <p className="text-xs sm:text-sm text-[#86868b] font-medium">
              Wyjścia HDMI i S/PDIF – idealne do odtwarzania muzyki z Music
              Assistant.
            </p>
          </motion.div>
        </div>
